    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Configure new rewards campaigns, set thresholds, and launch offers.</p>
        </div>
        ...
        <CardContent className="flex flex-col items-center justify-center gap-3 py-16 text-center">
          ...
          <div className="space-y-1">
            ...
            <p className="max-w-md text-sm text-muted-foreground">
              A list of your assigned campaigns will appear here. Live metrics are available on your dashboard overview.
            </p>
          </div>
        </CardContent>
      </Card>
