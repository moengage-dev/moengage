...
export default async function CampaignManagerAnalyticsPage() {
    ...
    return (
      <div className="space-y-6">
        <DashboardSectionHeader
          title="Analytics"
          description="Scan engagement, reward claims, and logistics for your assigned campaigns."
          ...
          <CardContent className="text-center space-y-4">
            ...
            <div className="max-w-md mx-auto space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                You are not currently assigned to any campaigns with scan or delivery activity.
              </p>
            </div>
          </CardContent>
        </Card>
