...
import { getAdvertiserAnalyticsDashboardData } from "@/server/services/analytics.service";
...
export default async function AdvertiserDashboardPage() {
  // Enforce Advertiser Viewer or Admin role
    ...
    return (
      <div className="space-y-6">
        <DashboardSectionHeader
          ...
          description="Read-only overview of assigned brand campaigns and user engagements."
  ...
  // Fetch advertiser dashboard analytics
  const data = await getAdvertiserAnalyticsDashboardData(advertiserId);
  const { metrics, performance } = data;

  return (
    <div className="space-y-6">
      <DashboardSectionHeader
        title={`${advertiserName} Dashboard`}
        description={`Performance analytics and campaign scans for ${advertiserName}.`}
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <AnalyticsStatCard
          ...
          description="Total scans logged for your campaigns"
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <AnalyticsTableSection
          ...
          description="Campaign stats evaluated by engagement scans, claims, and supply chain drops."
          headers={["Campaign Name", "Brand", "Scans", "Claims", "Declines", "Deliveries", "Units"]}
        ...
        <AnalyticsTableSection
          ...
          description="Geographic scan locations sorted by scan volume."
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <AnalyticsTableSection
          ...
          description="Latest consumer QR scans logged for your campaigns."
